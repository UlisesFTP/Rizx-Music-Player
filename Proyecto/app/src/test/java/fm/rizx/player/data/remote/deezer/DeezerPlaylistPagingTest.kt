...
class DeezerPlaylistPagingTest {
    ...
    private companion object NotImplemented : DeezerApi {
        ...
        override suspend fun track(id: String) = throw UnsupportedOperationException()
        override suspend fun trackByIsrc(isrc: String) = throw UnsupportedOperationException()
        ...
        override suspend fun genreChart(genreId: String, limit: Int) = throw UnsupportedOperationException()
